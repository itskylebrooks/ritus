...
export default function SettingsModal({ open, onClose, onShowGuide }: SettingsModalProps) {
  ...
  <div
  className={"w-full max-w-sm rounded-2xl bg-white dark:bg-black p-6 pt-7 pb-8 ring-1 ring-black/5 dark:ring-neutral-700/5 border border-neutral-200 dark:border-neutral-700 overflow-y-auto settings-panel " + (closing? 'closing':'')}
