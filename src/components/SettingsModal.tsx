...
export default function SettingsModal({ open, onClose, onShowGuide }: SettingsModalProps) {
  ...
  <div
  className={"w-full max-w-sm rounded-2xl bg-white dark:bg-neutral-950 p-6 pt-7 pb-8 ring-1 ring-black/5 dark:ring-neutral-700/5 border border-neutral-200 dark:border-neutral-700 overflow-y-auto settings-panel " + (closing? 'closing':'')}
      ...
      >
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="grid h-10 w-10 place-items-center rounded-lg border border-red-500 text-red-500 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 transition"
                >
        ...
        <div className="mt-5">
          <button onClick={beginClose} className="w-full rounded-2xl px-4 py-3 text-sm font-semibold bg-black text-white hover:bg-neutral-700 transition dark:bg-white dark:text-black dark:hover:bg-neutral-300">Done</button>
        </div>
