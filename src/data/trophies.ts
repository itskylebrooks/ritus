...
import { Zap, ShieldCheck, Sunrise, CalendarRange, Trophy, Medal, Scale, HeartPulse, Focus, BatteryFull, RefreshCcw, Clock, Hourglass, Infinity } from 'lucide-react'

export type TrophyGroup = 'daily_build' | 'daily_break' | 'weekly' | 'monthly' | 'totals' | 'meta' | 'milestone'
