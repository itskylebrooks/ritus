...
import { DAILY_MILESTONE, MILESTONE_BONUS, POINTS_PER_COMPLETION, WEEKLY_MILESTONE, countCompletionsInWeek, countCompletionsInMonth } from '@/shared/utils/scoring'
...
export default function HabitCard({ habit, disableEntryAnim = false }: { habit: Habit; disableEntryAnim?: boolean }) {
  ...
  const progressVal = useMemo(
    () => (habit.frequency === 'monthly' ? countCompletionsInMonth(habit.completions) : countCompletionsInWeek(habit.completions, new Date(), weekStartsOn)),
